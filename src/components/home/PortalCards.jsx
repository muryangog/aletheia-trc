...
export default function PortalCards() {
  return (
    <section className="py-16 bg-slate-50 dark:bg-slate-950/50 border-t border-b border-slate-200 dark:border-slate-800 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-[10px] font-bold text-[#48a848] uppercase tracking-wider bg-[#48a848]/10 px-2.5 py-1 rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* 1. VIDÉO */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg flex flex-col justify-between transition-colors duration-200">
            <div>
              <div className="flex justify-between items-start mb-4 relative z-10">
                <div className="p-3 bg-[#48a848]/15 border border-[#48a848]/30 rounded-xl text-[#48a848]">
                  <Video className="w-6 h-6" />
                </div>
                <span className="text-[8px] font-bold uppercase bg-[#48a848]/10 text-[#48a848] border border-[#48a848]/20 px-2 py-0.5 rounded-xl">
                  À voir
                </span>
              </div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg flex flex-col justify-between transition-colors duration-200">
            <div>
              <div className="flex justify-between items-start mb-4">
                <div className="p-3 bg-[#48a848]/10 border border-[#48a848]/20 rounded-xl text-[#48a848]">
