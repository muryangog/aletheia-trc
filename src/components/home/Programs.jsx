...
export default function Programs() {
  return (
    <section className="py-16 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-[#0c2448] text-white rounded-2xl p-6 sm:p-8 lg:p-10 shadow-lg relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 relative z-10 items-stretch">
          <div className="flex flex-col justify-center gap-4 lg:pr-4">
            <span className="self-start text-[11px] text-[#48a848] font-bold uppercase tracking-[0.16em] bg-[#48a848]/20 px-3 py-1.5 rounded-xl border border-[#48a848]/40">
              Horaires des Cultes
            </span>
          ...
          <div className="h-full bg-[#12305a] border border-[#294466] p-5 sm:p-6 rounded-2xl flex flex-col gap-5">
            <div className="flex justify-between items-center gap-3 border-b border-[#294466] pb-3">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wide bg-[#0c2448] px-2.5 py-1 rounded-xl">
                Louange
              </span>
            </div>
