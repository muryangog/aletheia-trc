...
export default function TeamGrid({ pastors }) {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen pb-12 sm:pb-20 transition-colors duration-200">
      {/* 1. HERO BANNER */}
      <section className="relative bg-[#0c2448] text-white py-14 sm:py-20 lg:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-xl bg-[#48a848]/20 border border-[#48a848]/40 text-[#5cbd5c] text-[10px] sm:text-xs font-semibold tracking-wider uppercase mb-3 sm:mb-4">
            Staff
          </span>
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-3 sm:mb-4">
            L'Équipe Pastorale
          </h1>
      ...
      <section className="py-10 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2 sm:mb-4">
