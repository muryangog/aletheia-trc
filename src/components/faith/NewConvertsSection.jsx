...
export default function NewConvertsSection() {
      ...
      <section className="relative bg-[#0c2448] text-white py-20 lg:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Le ciel se réjouit pour votre décision de suivre Jésus-Christ. C'est
            le début de la plus belle des aventures : la vie éternelle.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-12">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                Donner sa vie à Jésus-Christ est l'acte le plus important de
                votre vie. Vous êtes maintenant une nouvelle création : les
                choses anciennes sont passées, toutes choses sont devenues
                nouvelles. Pour vous aider à affermir votre marche chrétienne,
                voici trois piliers essentiels :
              </p>
            </div>
            ...
            <div className="bg-[#0c2448]/5 dark:bg-white/5 border border-[#0c2448]/10 dark:border-white/10 p-8 rounded-3xl">
              ...
              <div className="space-y-4 text-sm text-slate-600 dark:text-slate-400 italic">
                <p>
                  ...
                  ait la vie éternelle. » <br />
                  <span className="font-bold text-[#48a848] not-italic">
                    — Jean 3:16
                  </span>
                </p>
                <p>
                  « Si tu confesses de ta bouche le Seigneur Jésus, et si tu
                  crois dans ton cœur que Dieu l'a ressuscité des morts, tu
                  seras sauvé. » <br />
                  <span className="font-bold text-[#48a848] not-italic">
                    — Romains 10:9
                  </span>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-8 rounded-[2.5rem] shadow-xl sticky top-24">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-6">
              Remplissez ce court formulaire pour qu'un pasteur ou un encadreur
              spirituel vous recontacte afin de prier pour vous et vous
              accompagner.
            </p>
            ...
            {isSubmitted ? (
              <div className="py-12 text-center space-y-4">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed px-4">
                  Merci pour votre confiance. Un membre de l'équipe pastorale
                  vous contactera très rapidement par téléphone ou WhatsApp. Que
                  Dieu vous bénisse !
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-sm focus:outline-none focus:border-[#48a848] text-slate-800 dark:text-white transition-all"
                ...
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-wider text-slate-500 mb-1.5">
                    Sujet de prière ou questions (Optionnel)
                  </label>
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-sm focus:outline-none focus:border-[#48a848] text-slate-800 dark:text-white transition-all resize-none"
            ...
            <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800 flex gap-3.5 items-start">
              <div className="p-2 bg-[#48a848]/10 rounded-xl text-[#48a848] shrink-0 mt-0.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">
                  Notre programme d'affermissement doctrinal. Rejoignez les
                  sessions en vous signalant ci-dessus.
                </p>
              </div>
            </div>
          </div>
