  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen pb-20 transition-colors duration-200">
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-10 bg-[#0c2448] text-white p-6 rounded-2xl border border-[#48a848]/30 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col justify-between h-full transition-colors duration-200">
            <div>
              ...
              <div className="space-y-6 pt-4 border-t border-slate-100 dark:border-slate-800 text-xs">
                {INTERNATIONAL_ACCOUNTS.accounts.map((acc) => (
                  <div
                    key={acc.id}
                    className="p-5 bg-slate-50 dark:bg-slate-950 rounded-2xl space-y-3 border border-slate-200/50 dark:border-slate-800">
                    <div className="flex justify-between items-center border-b border-slate-200/50 dark:border-slate-800/50 pb-2">
                      <span className="font-bold text-slate-900 dark:text-[#48a848]">
                        {acc.label}
                      </span>
                      <span className="text-[10px] bg-blue-500/10 text-blue-500 px-2 py-0.5 rounded-xl font-bold">
                        {acc.badge}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2 text-[11px] sm:text-xs">
                      {acc.accountNumber && (
                        <div className="flex items-center justify-between gap-4">
                          <span className="text-slate-500 dark:text-slate-400">Nº de compte :</span>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-500 dark:text-slate-400 flex items-center gap-2">
                ...
                {LOCAL_ACCOUNTS.banks.map((bank, bIdx) => (
                  <div
                    ...
                    <div className="flex justify-between items-center border-b border-slate-200/50 dark:border-slate-800/50 pb-2">
                      ...
                      <span className="text-[10px] bg-[#48a848]/10 text-[#48a848] px-2.5 py-0.5 rounded-xl font-bold">
                        {bank.badge}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2.5 text-[11px] sm:text-xs">
                      {bank.accounts.map((acc) => (
                        <div
                          ...
                          <span className="text-slate-500 dark:text-slate-400">{acc.type} :</span>
                          <div className="flex items-center gap-1.5">
                            <span className="font-bold text-slate-900 dark:text-slate-100">
                              {acc.number}
                            </span>
