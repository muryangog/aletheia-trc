...
export default function MinistryModal({ selectedDept, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#071324]/90 flex items-center justify-center p-3 sm:p-4">
      <div className="bg-white dark:bg-[#0c2448] border border-slate-200 dark:border-[#294466] w-full max-w-3xl rounded-xl overflow-hidden shadow-lg relative flex flex-col max-h-[90vh]">
        {/* Bouton de Fermeture */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 sm:top-6 sm:right-6 p-2 bg-slate-100 dark:bg-[#12305a] hover:bg-slate-200 dark:hover:bg-[#294466] rounded-lg text-slate-700 dark:text-white transition-colors duration-150 z-20 outline-none cursor-pointer"
        ...
        <div className="p-5 sm:p-8 pb-4 border-b border-slate-100 dark:border-slate-800 flex items-start gap-4">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#0c2448]/10 dark:bg-[#12305a] border border-[#0c2448]/20 dark:border-[#294466] flex items-center justify-center text-[#48a848] shrink-0">
          ...
          <div className="space-y-1 pr-6">
            ...
            <h2 className="text-lg sm:text-2xl font-extrabold text-[#0c2448] dark:text-white">
              {selectedDept.name}
            </h2>
        ...
        <div className="p-5 sm:p-8 overflow-y-auto flex-1 space-y-6">
          ...
          {activeTab === "activities" && (
            <div className="space-y-4">
              <h4 className="font-bold text-xs sm:text-sm text-[#0c2448] dark:text-white uppercase tracking-wider">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-800">
                <span className="font-bold text-xs text-[#0c2448] dark:text-white block mb-1">
          ...
          {activeTab === "members" && (
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-200/50 dark:border-slate-800 flex items-center gap-3">
                ...
                <div>
                  <h5 className="font-bold text-xs sm:text-sm text-[#0c2448] dark:text-white">
                    {selectedDept.leader}
                  </h5>
        ...
        <div className="p-4 sm:p-6 bg-slate-50 dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-4.5 py-2.5 rounded-full bg-[#48a848] hover:bg-[#3d913d] text-white text-xs font-bold transition-all shadow-md order-1 sm:order-2">
